    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                int width_length = mPreviewSize.getWidth();
                int height_length = mPreviewSize.getHeight();
                proper_length = width_length > height_length ? height_length : width_length;
                mTextureView.setAspectRatio(proper_length, proper_length);
